...
export const content = {
  de: {
    navLinks: [
      ...
      { href: '/ideas', label: 'Ideen', visible: true },
      { href: '/contact', label: 'Kontakt', visible: true },
    ] as NavLink[],
    toggles: {
      testimonials: true,
    },
    ...
    ideas: [
      {
        title: 'Eigene App (in Arbeit)',
        goal: 'Ziel: XYZ',
        benefit: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
      },
      {
        title: 'Open-Source GitHub Projekt',
        goal: 'Ziel: Lorem ipsum',
        benefit: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
      },
    ] as Idea[],
  },
...
export function getContent(language: string) {
  return content[language as 'de' | 'en'] || content.de;
}
